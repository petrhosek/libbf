...
enum insn_mnemonic {
	...
	andnpd_insn	= INSN_TO_ENUM('a','n','d','n','p','d'),
	andpd_insn	= INSN_TO_ENUM('a','n','d','p','d'),
	andq_insn	= INSN_TO_ENUM('a','n','d','q'),
	...
	cmpltsd_insn	= INSN_TO_ENUM('c','m','p','l','t','s','d'),
	...
	notq_insn	= INSN_TO_ENUM('n','o','t','q'),
	or_insn		= INSN_TO_ENUM('o','r'),
	orb_insn	= INSN_TO_ENUM('o','r','b'),
	orl_insn	= INSN_TO_ENUM('o','r','l'),
	orpd_insn	= INSN_TO_ENUM('o','r','p','d'),
	orq_insn	= INSN_TO_ENUM('o','r','q'),
	...
	pushq_insn	= INSN_TO_ENUM('p','u','s','h','q'),
	...
	rorl_insn	= INSN_TO_ENUM('r','o','r','l'),
	...
	testq_insn	= INSN_TO_ENUM('t','e','s','t','q'),
