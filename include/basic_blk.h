 ...
 * target. Each node of a generated control flow graph (<b>CFG</b>) consists of
 * a bf_basic_blk. A CFG can be traversed either:
 ...
 * clean up.
 */
extern struct bf_basic_blk * bf_init_basic_blk(struct bin_file * bf,
		bfd_vma vma);
 ...
 */
extern struct bf_basic_blk * bf_split_blk(struct bin_file * bf,
 ...
 */
extern void bf_add_insn_to_bb(struct bf_basic_blk * bb, struct bf_insn * insn);
 ...
 */
extern void bf_add_bb(struct bin_file * bf, struct bf_basic_blk * bb);
 ...
 */
extern struct bf_basic_blk * bf_get_bb(struct bin_file * bf, bfd_vma vma);
 ...
 */
extern unsigned int bf_get_bb_size(struct bf_basic_blk * bb);
 ...
 */
extern unsigned int bf_get_bb_length(struct bf_basic_blk * bb);
 ...
 */
extern struct bf_insn * bf_get_bb_insn(struct bf_basic_blk * bb,
		unsigned int index);
...
extern void bf_enum_basic_blk_insn(struct bf_basic_blk * bb,
    void (*handler)(struct bf_basic_blk *, struct bf_insn *, void *),
    void * param);
